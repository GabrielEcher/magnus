            ...
            <div className="flex w-full max-w-sm flex-col gap-6">
                    <div className=" flex items-center justify-center rounded-md ">
                        <h1 className="flex items-center text-3xl font-medium">
                            <Icon iconNode={planet} className="mr-1 w-14 h-14"/> Magnus
                        </h1>
                    </div>
                ...
                <div className={cn("flex flex-col gap-6")}>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input id="email" type="email" placeholder="email@email.com" {...field} />
                                                            </FormControl>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
                    ...
                    <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-primary  ">
                        Ao clicar em LOGIN você concorda com nossos <a href="#">Termos de serviço</a> e <a href="#">Política de Privacidade</a>.
                    </div>
                </div>
            </div>
        </div>
